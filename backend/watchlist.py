    ...
    "台灣": {
        "半導體": {
            "晶圓代工": [
                ...
                {"symbol": "5347.TW",  "name": "世界先進",     "name_en": "Vanguard International Semiconductor","tags": ["PMIC/Driver代工", "8吋廠"]},
            ...
            "IC設計": [
                ...
                {"symbol": "5274.TW",  "name": "信驊科技",     "name_en": "Aspeed Technology",                 "tags": ["BMC伺服器管理IC", "AI伺服器"]},
                {"symbol": "3529.TW",  "name": "力旺電子",     "name_en": "eMemory Technology",                "tags": ["嵌入式NVM IP", "eFlash/eMCM"]},
                ...
                {"symbol": "4966.TW",  "name": "譜瑞-KY",      "name_en": "Parade Technologies",               "tags": ["顯示介面IC", "TCON/eDP"]},
                ...
                {"symbol": "6643.TW",  "name": "M31科技",      "name_en": "M31 Technology Corp",               "tags": ["矽智財 PHY IP", "SerDes"]},
                {"symbol": "3227.TW",  "name": "原相科技",     "name_en": "PixArt Imaging",                    "tags": ["光學感測器", "影像處理IC"]},
            ...
            "記憶體": [
                ...
                {"symbol": "8299.TW",  "name": "群聯電子",     "name_en": "Phison Electronics",                "tags": ["NAND主控", "SSD/eMMC方案"]},
                ...
                {"symbol": "3260.TW",  "name": "威剛科技",     "name_en": "ADATA Technology",                  "tags": ["DRAM模組", "SSD品牌通路"]},
            ...
            "封裝測試": {
                "封測廠": [
                    ...
                    {"symbol": "3264.TW",  "name": "欣銓科技",   "name_en": "Chipbond Technology",             "tags": ["驅動IC封測", "CoF/COG"]},
                ...
                "探針卡": [
                    {"symbol": "6510.TW",  "name": "精測電子",   "name_en": "Chunghwa Precision Test Tech",    "tags": ["高速探針卡", "HBM/AI晶片測試"]},
                    {"symbol": "6223.TW",  "name": "旺矽科技",   "name_en": "MJC Probe",                       "tags": ["DRAM探針卡", "垂直型探針"]},
                ],
                "IC載板": [
            ...
            "功率元件": [
                {"symbol": "3707.TW",  "name": "漢磊科技",     "name_en": "Han Lei Technology",                "tags": ["SiC磊晶代工", "GaN Epi"]},
                {"symbol": "8255.TW",  "name": "朋程科技",     "name_en": "Anpec Electronics",                 "tags": ["整流橋", "車用電源IC"]},
                {"symbol": "2481.TW",  "name": "強茂",         "name_en": "General Semiconductor",             "tags": ["TVS/Zener", "整流器"]},
                {"symbol": "5425.TW",  "name": "台半",         "name_en": "Taiwan Semiconductor Co.",          "tags": ["功率MOSFET", "整流器"]},
                {"symbol": "3105.TW",  "name": "穩懋半導體",   "name_en": "WIN Semiconductors",                "tags": ["GaN PA", "5G RF前端"]},
                {"symbol": "8086.TW",  "name": "宏捷科技",     "name_en": "Advanced Wireless Semiconductor",   "tags": ["GaAs PA", "5G毫米波RF"]},
                {"symbol": "5299.TW",  "name": "杰力科技",     "name_en": "Jetek Semiconductor",               "tags": ["功率MOSFET", "GaN充電"]},
                {"symbol": "3675.TW",  "name": "德微科技",     "name_en": "De Wei Technology",                 "tags": ["功率離散元件", "MOSFET/整流"]},
                {"symbol": "2342.TW",  "name": "茂矽電子",     "name_en": "MoselVitelic",                      "tags": ["MOSFET", "功率IC"]},
                {"symbol": "3317.TW",  "name": "尼克森微",     "name_en": "Niko Semiconductor",                "tags": ["功率MOSFET", "小封裝"]},
                {"symbol": "2455.TW",  "name": "全新光電",     "name_en": "Advanced Photonics",                "tags": ["LED晶粒", "化合物半導體"]},
                {"symbol": "6616.TW",  "name": "特昇科技",     "name_en": "Teresic Technology",                "tags": ["SiC基板/磊晶"]},
                {"symbol": "6104.TW",  "name": "創杰科技",     "name_en": "Carsem Semiconductor",              "tags": ["GaN RF PA"]},
                {"symbol": "2448.TW",  "name": "晶元光電",     "name_en": "Epistar",                           "tags": ["LED晶粒", "Mini/Micro LED"]},
            ],
            "材料": [
                # 晶圓 / 基板
                {"symbol": "6488.TW",  "name": "環球晶圓",     "name_en": "GlobalWafers",                      "tags": ["矽晶圓", "全球前三大"]},
                {"symbol": "6182.TW",  "name": "合晶科技",     "name_en": "Sino-American Silicon",             "tags": ["矽晶圓 CZ/FZ", "6\"/8\""]},
                ...
                {"symbol": "4503.TW",  "name": "金洲精密",     "name_en": "Chin Chou Precision",               "tags": ["石英製品", "精密零件"]},
                ...
                {"symbol": "4768.TW",  "name": "晶呈科技",     "name_en": "Cryscore Optoelectronic",           "tags": ["SiC研磨材料", "化學機械研磨"]},
                {"symbol": "4772.TW",  "name": "台特化",       "name_en": "Taiwan Speciality Chemicals",       "tags": ["特殊製程化學品", "前段濕製程"]},
                {"symbol": "5434.TW",  "name": "崇越科技",     "name_en": "Topco Scientific",                  "tags": ["半導體材料代理", "氣體通路商"]},
                {"symbol": "3680.TW",  "name": "家登精密",     "name_en": "Gudeng Precision Industrial",       "tags": ["光罩盒 FOUP/FOSB", "前開式晶圓盒"]},
            ],
            "設備": [
                ...
                {"symbol": "5536.TW",  "name": "聖暉企業",     "name_en": "Summit Grand Enterprise",           "tags": ["機電工程", "廠務維運"]},
                {"symbol": "6691.TW",  "name": "洋基工程",     "name_en": "Yankee Engineering Corp",           "tags": ["工業氣體管路", "高壓氣體系統"]},
                {"symbol": "3131.TW",  "name": "弘塑科技",     "name_en": "Hung Hing Precision Technology",    "tags": ["濕式清洗/蝕刻設備"]},
                ...
                {"symbol": "6187.TW",  "name": "萬潤科技",     "name_en": "Wan Jung Technology",               "tags": ["AOI光學檢測設備", "點膠設備"]},
        ...
        "科技系統廠": {
            ...
            "PCB": [
                {"symbol": "3189.TW",  "name": "景碩科技",     "name_en": "Kinsus Interconnect Technology",    "tags": ["ABF載板", "FC-BGA"]},
                {"symbol": "3037.TW",  "name": "欣興電子",     "name_en": "Unimicron Technology",              "tags": ["ABF/BT載板", "HDI軟板"]},
                {"symbol": "3363.TW",  "name": "上诠",         "name_en": "Compeq Manufacturing",              "tags": ["柔性電路板", "FPC/軟板"]},
                {"symbol": "8046.TW",  "name": "南電",          "name_en": "Nan Ya PCB",                        "tags": ["ABF載板", "伺服器GPU封裝"]},
                {"symbol": "1519.TW",  "name": "華城",         "name_en": "Hwa Chuang Electronics",            "tags": ["多層硬板", "通訊PCB"]},
                {"symbol": "3163.TW",  "name": "波若威",       "name_en": "Powertec Technology",              "tags": ["精密電路板", "IC載板"]},
                {"symbol": "4958.TW",  "name": "臻鼎科技",     "name_en": "Zhen Ding Technology",              "tags": ["HDI軟硬板", "FPC", "蘋果供應鏈"]},
            ],
            "科技ETF": [
        ...
        "資源": {
            "稀土/戰略金屬": [
                {"symbol": "1785.TW",  "name": "光洋科技",     "name_en": "Gallant Metals Co.",                "tags": ["貴金屬/稀土回收", "鉭/鎢材料"]},
                {"symbol": "8390.TW",  "name": "金益鼎",       "name_en": "Chin I Ding Precious Metal",        "tags": ["貴金屬回收交易", "稀有金屬"]},
